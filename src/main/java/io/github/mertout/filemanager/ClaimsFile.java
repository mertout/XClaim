...
public class ClaimsFile
{
    ...
    public static void loadClaimFiles() {
        ...
        if (!ClaimsFile.clfile.exists()) {
            ...
            (ClaimsFile.clfc = (FileConfiguration)YamlConfiguration.loadConfiguration(ClaimsFile.clfile)).createSection("claims");
            try {
        ...
        ClaimsFile.clfc = (FileConfiguration)YamlConfiguration.loadConfiguration(ClaimsFile.clfile);
    }
